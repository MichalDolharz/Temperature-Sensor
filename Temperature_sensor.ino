...
#define LM35 A4 
#define interval 5UL // seconds (UL is needed for compiler to make it unsigned long type)
...
void setup(){
  ...
  RTC.setDS1302Time(00, 01, 21, 3, 21, 07, 2021);
...
void loop(){
  ...
  if(timeNow - timestamp >= interval * 0.2 * 1000)
  {
